...
parser.add_argument('--spot_progress-reward', action='store_true', help='use progress reward')
parser.add_argument('--action-reward-penalty', action='store_true', help='penalize certain actions in progress reward')
parser.add_argument('--spot_trial-reward', action='store_true', help='use spot trial reward')
